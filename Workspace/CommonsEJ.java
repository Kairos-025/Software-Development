...
public class CommonsEJ extends JPanel {
	...
	public CommonsEJ(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("EJ's Common File");            // NOTE: change XY to student's initials
		frame.getContentPane().add(new CommonsEJ(create_Scene()));  // create an instance of the class
